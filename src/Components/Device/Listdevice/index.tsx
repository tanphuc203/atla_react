  ...
  const handleDropdownValue = (e: any) => {
    if (e.value == "Hoạt động") {
      ...
      const filterdata = data.filter(
        (item: any) => item.status == "Ngưng hoạt động"
      );
      setDataEquiment(filterdata);
    } else if (e.value == "Ngưng hoạt động") {
      const filterdata = data.filter(
  ...
  return (
    <div className={classes.device}>
      <div className={classes.info}>
        <div className={classes.infolist}>
          ...
          <img
            src={Levelgoto}
            alt="levelgoto"
            className={classes.devicegoto}
          ></img>

          <div className={classes.detaillist}>Danh sách thiết bị</div>
        </div>
      ...
      <div className={classes.container}>
        <div className={classes.listtitle}>Danh sách thiết bị</div>
      ...
      <div className={classes.tablelistitem}>
        <div className={classes.devicetable}>
          ...
          <div className={classes.deviceitemname} style={{ width: "171px" }}>
            <div className={classes.deviceitemnametitle}>
              {" "}
